...
ActiveRecord::Schema.define(version: 20170414030758) do
  ...
  create_table "reviews", force: :cascade do |t|
    ...
    t.index ["snake_id"], name: "index_reviews_on_snake_id", using: :btree
  ...
  create_table "snakes", force: :cascade do |t|
    ...
    t.float    "latitude"
    t.float    "longitude"
    t.index ["user_id"], name: "index_snakes_on_user_id", using: :btree
  end
  ...
  add_foreign_key "bookings", "snakes"
  add_foreign_key "bookings", "users"
  add_foreign_key "reviews", "bookings"
  add_foreign_key "reviews", "snakes"
  add_foreign_key "reviews", "users"
  add_foreign_key "snakes", "users"
end
